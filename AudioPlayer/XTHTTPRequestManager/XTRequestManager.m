...
+ (instancetype)sharedManager {
    ...
    dispatch_once(&onceToken, ^{
        ...
        XTJSONRequestSerializer *requestSer  = [XTJSONRequestSerializer serializer];
        XTJSONResponseSerializer *responseSer = [XTJSONResponseSerializer serializer];
        responseSer.xtCurrentRequest = requestSer.xtrequest;
        [requestSer setCachePolicy:NSURLRequestReturnCacheDataElseLoad];
        _instance.requestSerializer = requestSer;
        _instance.responseSerializer = responseSer;
